// Generated from /Users/admin/IdeaProjects/Project1Group7/src/parser/GLangLexer.g4 by ANTLR 4.13.2
package parser;
...
public class GLangLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DEFINE", "COMPOSE", "LOOP", "END", "TYPE_CHORD", "TYPE_BAR", "TYPE_SEGMENT", 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "'Define'", "'Compose'", null, "'end'", "'CHORD'", "'BAR'", "'SEGMENT'", 
	...
	@Override
	public String getGrammarFileName() { return "GLangLexer.g4"; }
